...
class PricingPlan(models.Model):
    ...
    vendor_limit = models.IntegerField(default=3)
    product_limit_per_vendor = models.IntegerField(default=100)
    order_limit = models.IntegerField(default=1000)
    agent_limit = models.IntegerField(default=3)
    ai_reply_limit = models.IntegerField(default=1000)
    channels_allowed = models.JSONField(default=list, blank=True)
